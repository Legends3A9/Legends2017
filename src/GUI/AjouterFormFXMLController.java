...
public class AjouterFormFXMLController implements Initializable {
    ...
    private void ActionAjouter(ActionEvent event) throws IOException {
        ...
        if (nom_stadeS.equals("") || regionS.equals("") || adresseS.equals("") || date_construction.equals(null) ||surfaceS.equals("") || capaciteS.equals("")||image.equals("")) {Alert alert = new Alert(Alert.AlertType.INFORMATION);
        alert.setTitle("Votre demende n'est pas valide");
        alert.setHeaderText("vous dever rempirir tout les champs");
        ...
        Stade s = new Stade(nom_stadeS,regionS,adresseS, datecons, surfaceS,Integer.parseInt(capaciteS) ,imageS);
         ...
         Services.StadeService ss = new StadeService(); 
        ss.insererStade(s);
        Alert alert = new Alert(Alert.AlertType.INFORMATION);
        alert.setTitle("Votre demende d'ajout de stade a ete prix en compte");
        alert.setHeaderText("Stade ajouter");
        ...
        region.setText("");
        adresse.setText("");
        date_construction.setValue(null);
        surface.setText("");
        capacite.setText("");
        image.setText("");
        }
