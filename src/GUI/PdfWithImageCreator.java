...
public class PdfWithImageCreator extends Application {
 ...
 File imageURL = new File("C:\\Users\\melek\\Documents\\NetBeansProjects\\russie2018\\Images\\003-add.png");
    @Override public void start(Stage stage) {
        VBox layout = new VBox(20);

        ImageView imageView = new ImageView(
            new Image(imageURL.toURI().toString())
        );
        
        Button export = new Button("Export");
        Text la =new Text("eae");
        imageView.setAccessibleText(PDF_PATH);
