...
public class Equipe {
   public int id;
    ...
    public Equipe(int id, String nom_equipe, String nom_poule, String continent, int nbr_joueur, int nbr_participation, int nbr_coupe, double taux_victoire) {
        this.id = id;
    ...
    public Equipe(String nom_equipe, String nom_poule, String continent, int nbr_joueur, int nbr_participation ,int nbr_coupe, double taux_victoire) {
        this.nom_equipe = nom_equipe;
        this.nom_poule = nom_poule;
        this.continent = continent;
        this.nbr_joueur = nbr_joueur;
    ...
    public Equipe(String nom_equipe, String nom_poule, String continent, int nbr_joueur, int nbr_participation ,int nbr_coupe) {
        this.nom_equipe = nom_equipe;
        this.nom_poule = nom_poule;
        this.continent = continent;
        this.nbr_joueur = nbr_joueur;
