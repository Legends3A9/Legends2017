...
//mod 1
    public Utilisateur(String nom, String prenom, String email, String password, String telephone, String nationalite, String role, String login, String Photo, float argent) {
        this.nom = nom;
        this.prenom = prenom;
        this.email = email;
        this.password = password;
    ...
    public Utilisateur(int idUser,String nom, String prenom, String email, String password, String telephone, String nationalite, String role, String login, String Photo, float argent) {
        this.idUser=idUser;
        this.nom = nom;
        this.prenom = prenom;
        this.email = email;
    ...
    public String toString() {
        return "Utilisateur{" + "idUser=" + idUser + ", nom=" + nom + ", prenom=" + prenom + ", email=" + email + ", password=" + password + ", telephone=" + telephone + ", nationalite=" + nationalite + ", role=" + role + ", login=" + login + ", Photo=" + Photo + ", argent=" + argent +'}';
    }
